...
public class MicroIntegratorRegistry extends AbstractRegistry {
    ...
    public void newNonEmptyResource(String path, boolean isDirectory, String mediaType, String content,
        ...
        newNonEmptyResource(path, isDirectory, mediaType, content, properties);
    }
     ...
     */
    private void writeToFile(File parent, String newFileName, String content, Properties metadata,
        ...
        */
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(newFile))) {
            ...
            handleException("Couldn't write to registry resource: " + parent.getPath() + URL_SEPARATOR + newFileName,
                            e);
        }
    }
